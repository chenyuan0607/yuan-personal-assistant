...
test("assistant composer overlays chat without a reserved gray spacer", async () => {
  ...
  assert.match(css, /\.assistant-messages\{[^}]*position:fixed/);
  assert.match(css, /\.assistant-messages\{[^}]*top:56px/);
  assert.match(css, /\.assistant-messages\{[^}]*bottom:calc\(102px \+ env\(safe-area-inset-bottom\)\)/);
  assert.match(css, /\.assistant-messages\{[^}]*height:auto/);
  assert.match(css, /\.assistant-messages\{[^}]*max-height:none/);
  assert.doesNotMatch(css, /\.assistant-messages\{[^}]*100dvh/);
  assert.match(css, /\.assistant-messages\{[^}]*margin:0/);
  assert.match(css, /\.assistant-messages\{[^}]*padding:8px 8px 28px/);
  assert.match(css, /\.assistant-messages\{[^}]*scroll-padding-bottom:28px/);
  ...
  assert.match(css, /\.assistant-composer\{[^}]*gap:6px/);
  assert.match(css, /\.assistant-composer\{[^}]*padding:4px 10px/);
  assert.match(css, /\.assistant-composer\{[^}]*background:#f7f7f7/);
  assert.match(css, /\.assistant-composer\{[^}]*border-top:1px solid #eeeeee/);
  assert.match(css, /\.assistant-composer textarea\{[^}]*min-width:0/);
  assert.match(css, /\.assistant-composer textarea\{[^}]*min-height:32px/);
  assert.match(css, /\.assistant-composer \.primary\{[^}]*height:32px/);
  assert.match(css, /\.composer-icon\{[^}]*width:32px/);
