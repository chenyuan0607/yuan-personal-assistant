...
test("assistant composer overlays chat without a reserved gray spacer", async () => {
  ...
  assert.match(css, /\.assistant-messages\{[^}]*bottom:calc\(96px \+ env\(safe-area-inset-bottom\)\)/);
  ...
  assert.match(css, /\.assistant-messages\{[^}]*padding:8px 8px 38px/);
  assert.match(css, /\.assistant-messages\{[^}]*scroll-padding-bottom:38px/);
  ...
  assert.match(css, /\.assistant-composer\{[^}]*padding:2px 10px/);
  ...
  assert.match(css, /\.assistant-composer textarea\{[^}]*min-height:30px/);
  assert.match(css, /\.assistant-composer \.primary\{[^}]*height:30px/);
  assert.match(css, /\.composer-icon\{[^}]*width:30px/);
