...
test("assistant composer overlays chat without a reserved gray spacer", async () => {
  ...
  assert.match(css, /\.assistant-messages\{[^}]*bottom:calc\(108px \+ env\(safe-area-inset-bottom\)\)/);
  ...
  assert.match(css, /\.assistant-messages\{[^}]*padding:8px 8px 18px/);
  assert.match(css, /\.assistant-messages\{[^}]*scroll-padding-bottom:18px/);
  ...
  assert.match(css, /\.assistant-composer\{[^}]*padding:5px 10px/);
  ...
  assert.match(css, /\.assistant-composer textarea\{[^}]*min-height:34px/);
  assert.match(css, /\.assistant-composer \.primary\{[^}]*height:34px/);
  assert.match(css, /\.composer-icon\{[^}]*width:34px/);
